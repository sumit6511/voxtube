...
const LANG_SHAPE: Record<string, string> = {
  nepali:  '●',
  english: '■',
  neplish: '◆',
}
...
export default function ScatterPlot({ jobId }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card overflow-hidden p-2">
        <ResponsiveContainer width="100%" height={440}>
          <ScatterChart margin={{ top: 10, right: 20, bottom: 10, left: 0 }}>
            ...
            <Scatter data={coloredPoints} isAnimationActive={false}>
      ...
      <p className="text-xs font-mono text-gray-700">
        Each dot = one comment · hover for details · proximity = semantic similarity
      </p>
    </div>
  )
}
